...
# Enums extracted to contact_enums.py (TD-012)
from models.contact_enums import (  # noqa: F401 — re-exported for backward compat
    AgeGroupEnum,
    ContactTypeEnum,
    EducationEnum,
    FormEnum,
...
class Phone(db.Model):
    ...
    primary = db.Column(
        Boolean, default=False
    )  # Only one phone per contact should be primary
