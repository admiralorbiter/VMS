...
class BugReport(db.Model):
    ...
    submitted_by = db.relationship("User", foreign_keys=[submitted_by_id], backref=db.backref("bug_reports", lazy=True))

    # Admin fields
    resolved = db.Column(db.Boolean, default=False)
    resolved_by_id = db.Column(db.Integer, db.ForeignKey("users.id"))
    resolved_by = db.relationship("User", foreign_keys=[resolved_by_id], backref=db.backref("resolved_bug_reports", lazy=True))
