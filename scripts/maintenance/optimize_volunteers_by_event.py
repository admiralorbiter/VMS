...
def optimized_query_volunteers(
    start_date, end_date, selected_types, title_contains=None
):
...
def test_performance():
    ...
    with app.app_context():
        ...
        if volunteers:
            sample = volunteers[0]
            print(
                f"Sample volunteer: {sample['name']} - {sample['event_count']} events, {sample['total_volunteer_count']} total"
            )
