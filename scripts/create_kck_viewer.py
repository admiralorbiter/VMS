#!/usr/bin/env python3
"""
DEPRECATED: KCK Viewer User Creation Script
==========================================

⚠️  DEPRECATED: This script is deprecated in favor of the new district-scoped user system.
    Use the Admin panel (/admin) to create district-scoped users instead.
...
def create_kck_viewer():
    ...
    with app.app_context():
        ...
        print(
            "KCK viewers have restricted access to only the Kansas City Kansas Public Schools teacher progress page.\n"
        )
        ...
        try:
            ...
            print(
                "http://127.0.0.1:5050/reports/virtual/usage/district/Kansas%20City%20Kansas%20Public%20Schools/teacher-progress?year=2025-2026&date_from=2025-08-01&date_to=2026-07-31"
            )
