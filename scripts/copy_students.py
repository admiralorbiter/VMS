...
from models.contact import Contact, AgeGroupEnum, EducationEnum, GenderEnum, RaceEthnicityEnum, SalutationEnum, SuffixEnum
    ...
    with app.app_context():
        ...
        try:
            ...
            while True:
                ...
                print(f"Processed: {total_processed:,} records | Copied: {total_copied:,} | Skipped: {total_skipped:,} | Rate: {rate:.1f} records/sec | Chunk time: {chunk_time:.2f}s")
