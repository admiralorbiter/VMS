...
def test_salesforce_client_import():
    ...
    try:
        ...
        logger.error("Salesforce client import testing failed: %s", e)
...
def test_count_validator_import():
    ...
    try:
        ...
        logger.error("Count validator import testing failed: %s", e)
...
def test_validation_engine_import():
    ...
    try:
        ...
        logger.error("Validation engine import testing failed: %s", e)
