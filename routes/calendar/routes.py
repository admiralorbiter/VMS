...
Handles calendar view and event data API endpoints for the FullCalendar integration.
"""
...
def get_events():
    ...
    It returns events in the format expected by FullCalendar.
    ...
    ).order_by(getattr(Event, 'start_date')).all()  # Use getattr to ensure column for linter
