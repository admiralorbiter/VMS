"""
Data processing and computation helpers for virtual session reports.

Contains filtering, summary calculation, pagination, and the core
compute functions for session data and district-level data.
"""
