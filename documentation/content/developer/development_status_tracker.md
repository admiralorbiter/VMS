...
| FR-DELTA-014 | Retry queue for unresolved participation imports | ✅ | TD-057 resolved 2026-04-28 — `PendingParticipationImport` model; auto-resolves on next import
