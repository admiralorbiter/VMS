...
| <a id="nfr-5"></a>**NFR-5** | Auditability | Key actions (publishing toggles, district linking, imports, teacher flags) shall be logged. | [FR-INPERSON-104](requirements#fr-inperson-104), [FR-INPERSON-107](requirements#fr-inperson-107), [FR-VIRTUAL-206](requirements#fr-virtual-206), [FR-DISTRICT-507](requirements#fr-district-507), [Audit Requirements](audit_requirements) |
