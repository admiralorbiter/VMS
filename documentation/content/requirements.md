...
Each **FR-xxx** is referenced by test cases in **Test Packs 1–6**. User stories with acceptance criteria in **[User Stories](user_stories)**. End-to-end workflows in **[Use Cases](use_cases)**.
