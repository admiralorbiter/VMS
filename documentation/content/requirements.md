...
| <a id="fr-tenant-103"></a>**FR-TENANT-103** | The system shall route authenticated users to their tenant's database and enforce tenant-scoped access for all operations. | [TC-890](test-pack-8#tc-890), [TC-891](test-pack-8#tc-891) *(Pending)* | *Technical requirement* |
