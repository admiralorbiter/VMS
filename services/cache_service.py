"""
Virtual Session Cache Service
==============================

Canonical location for cache CRUD operations on VirtualSessionReportCache
and VirtualSessionDistrictCache models.

Consolidated from:
  - routes/virtual/usage/cache.py        (TD-042, removed)
  - routes/reports/virtual_session/cache.py  (TD-042, removed)
  - routes/virtual/usage/computation.py  (inline copy, removed)
