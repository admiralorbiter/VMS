...
def test_process_teacher_data_with_multiple_teachers(app):
    ...
    with app.app_context():
        ...
        row_data = {"Teacher Name": "James Brockway/Megan Gasser", "School Name": "Test School", "District": "Test District"}
...
def test_process_teacher_for_event_with_multiple_teachers(app):
    ...
    with app.app_context():
        ...
        event = Event(title="Test Virtual Session", type=EventType.VIRTUAL_SESSION, status=EventStatus.COMPLETED, start_date=datetime.now(timezone.utc))
        db.session.add(event)
        db.session.commit()

        # Create test data with multiple teachers
        row_data = {"Teacher Name": "James Brockway/Megan Gasser", "School Name": "Test School", "District": "Test District", "Status": "Completed"}
