...
def test_add_organization(client, auth_headers):
    ...
    org_data = {"name": "Test Organization", "type": "Non-Profit", "website": "https://test.org", "description": "Test organization description"}
...
def test_organization_validation(client, auth_headers):
    ...
    invalid_data = {"name": "", "website": "invalid-url"}  # Invalid empty name  # Invalid URL format
