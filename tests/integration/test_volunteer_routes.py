...
from models.contact import Email, Phone, GenderEnum, RaceEthnicityEnum, LocalStatusEnum, EducationEnum
import json
...
def test_add_volunteer(client, auth_headers, app):
    ...
    with app.app_context():
        ...
        response = safe_route_test(client, '/volunteers/add', method='POST',
                             data=data,
