...
def test_volunteer_organization_relationship(app, test_volunteer):
    ...
    with app.app_context():
        ...
        try:
            ...
            vol_org = VolunteerOrganization(volunteer_id=test_volunteer.id, organization_id=org.id, role="Software Engineer", is_primary=True, status="Current")
...
def test_organization_salesforce_url(app):
    ...
    with app.app_context():
        ...
        try:
            ...
            org_with_sf = Organization(name="SF Test Org", salesforce_id="001TEST123456789")
...
def test_volunteer_organization_cascade(app, test_volunteer):
    ...
    with app.app_context():
        ...
        try:
            ...
            # Create volunteer organization relationship
            vol_org = VolunteerOrganization(volunteer_id=test_volunteer.id, organization_id=org.id, role="Tester")
            db.session.add(vol_org)
            ...
            vol_org_exists = db.session.query(VolunteerOrganization).filter_by(volunteer_id=test_volunteer.id, organization_id=org_id).first()
...
def test_volunteer_organization_multiple_relationships(app, test_volunteer):
    ...
    with app.app_context():
        ...
        try:
            ...
            vol_org1 = VolunteerOrganization(volunteer_id=test_volunteer.id, organization_id=org1.id, role="Manager", is_primary=True, status="Current")
            vol_org2 = VolunteerOrganization(volunteer_id=test_volunteer.id, organization_id=org2.id, role="Contributor", is_primary=False, status="Past")
...
def test_volunteer_organization_date_validation(app, test_volunteer):
    ...
    with app.app_context():
        ...
        try:
            ...
            vol_org = VolunteerOrganization(volunteer_id=test_volunteer.id, organization_id=org.id, start_date=start_date, end_date=end_date)
            db.session.add(vol_org)
            db.session.flush()
...
def test_organization_address_fields(app):
    ...
    with app.app_context():
        ...
        try:
            ...
            org1 = Organization(name="Minimal Address Org", billing_city="Test City", billing_state="TS")
            db.session.add(org1)
            db.session.flush()
