...
def test_teacher_contact_info(app):
    ...
    with app.app_context():
        ...
        # Add email
        email = Email(email="teacher@test.com", type=ContactTypeEnum.personal, primary=True)
        teacher.emails.append(email)

        # Add address
        address = Address(address_line1="123 School St", city="Test City", state="TS", zip_code="12345", type=ContactTypeEnum.personal, primary=True)
...
def test_teacher_inheritance(app):
    ...
    with app.app_context():
        ...
        email = Email(email="test@example.com", type=ContactTypeEnum.personal, primary=True)
        teacher.emails.append(email)
