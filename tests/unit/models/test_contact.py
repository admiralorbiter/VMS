...
from models.contact import Address, Contact, ContactTypeEnum, Email, GenderEnum, Phone, SalutationEnum, SuffixEnum
...
def test_email_to_dict(test_contact):
    ...
    assert email_dict == {"id": email.id, "email": "john.doe@example.com", "type": "personal", "primary": True}
