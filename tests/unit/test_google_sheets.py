...
class TestGoogleSheetsEncryption:
    ...
    def test_encryption_decryption(self, app):
        ...
        with app.app_context():
            ...
            assert decrypted_id == test_sheet_id, f"Expected {test_sheet_id}, got {decrypted_id}"
...
class TestAcademicYearUtils:
    ...
    def test_validate_academic_year_invalid_years(self):
        ...
        for year in invalid_years:
            assert not validate_academic_year(year), f"Invalid year {year} should be rejected"
...
class TestGoogleSheetsDatabase:
    ...
    def test_sheet_creation(self, app):
        ...
        with app.app_context():
            test_sheet = GoogleSheet(academic_year="2023-2024", sheet_id="test_sheet_id_123")
            ...
            assert retrieved_sheet.decrypted_sheet_id == "test_sheet_id_123", "Wrong decrypted sheet ID"
    ...
    def test_sheet_update(self, app):
        ...
        with app.app_context():
            ...
            assert updated_sheet.academic_year == "2024-2025", "Academic year should be updated"
